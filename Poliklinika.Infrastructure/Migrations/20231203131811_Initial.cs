        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecifyingDate = table.Column<int>(type: "int", nullable: false),
                    CreateAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appintment_Doctor_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Appintment_Patient_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appintment_DoctorId",
                table: "Appintment",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_Appintment_PatientId",
                table: "Appintment",
                column: "PatientId");
